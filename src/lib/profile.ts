export const CONTACT_EMAIL = "business.alfonsocnd@gmail.com";

export const CV_DOWNLOAD_PATH = "/Alfonso_Raphael_Candia_CV.pdf";

export const INSTAGRAM_USERNAME = "don.fnso";

export const INSTAGRAM_PROFILE_URL = "https://www.instagram.com/don.fnso/";
...
export const PROFILE_HIGHLIGHTS = [
  ...
  "Photography, illustration, and content presentation",
];
